        ...
        <form>
          ...
          <div class="flex">
            <div class="from-class">
              ...
              <div
                class="input-cont-md"
                style="box-shadow: none; padding: 8px 0px"
              >
                <label for="p"> Publice </label>
                <input
                  type="radio"
                  value="Publice"
          ...
          <div class="from-btn">
            <button class="recipe-btn" @click.prevent="Updaterecipe">
              Submit
            </button>
    ...
    async Updaterecipe() {
      ...
      const res = await axios.put(
        "http://localhost:3000/addrecepidb/" + this.$route.params.id,
        {
          ...
          TotalServe: this.recipe.TotalServe,
          ingredeients: this.recipe.ingredeients,
          Methods: this.recipe.Methods,
          Chef: this.recipe.Chef,
          Stutus: this.recipe.Stutus,
          unit: this.recipe.unit,
          water: this.recipe.water,
          pices: this.recipe.pices,
        }
      );
      this.$router.push({
        path: "/",
...
.input-cont-md {
  ...
  border: none;
  outline: none;
  box-shadow: 0px 0px 3px rgb(128, 123, 123);
}
